...
![sketches baja fidelidad](images/sketches-bajafidelidad.jpg)
...
de acuerdo a MOMSdata.com “Facebook y YouTube son las plataformas con mayor penetración en el nicho de las madres mexicanas. Es fácil imaginarse las razones por las cuales las prefieren, pues no solo las utilizan en el ámbito personal, para sus hij@s se han convertido en extensiones de sus juguetes, ya que permiten el entretenimiento de l@s pequeñ@s en todos los lugares donde las madres se desenvuelven con ellos, ocupando un lugar privilegiado dentro de las rutinas diarias.
...
Combinar su experiencia profesional y su rol como mamás
oportunidad de reincorporarse a la vida laboral desde casa y seguir acompañando a lo que más quieren: su familia
...
La técnica implementada para el primer acercamiento y conocer a nuestras usuaras  en esta fase ha sido la aplicación de encuestas

##  Objetivos del negocio: (Enlistarlo(s))
Crear una comunidad de mujeres profesionistas y madres de tiempo completo que pueda ser un punto de encuentro para compartir sus experiencias laborales, familiares y cómo pueden encontra el balance vital para sentirse plenas
 

##  Motivaciones del negocio para una red social:(Enlistarlo(s))
Crear una comunidad de mujeres que se mantenga en constante crecimiento
